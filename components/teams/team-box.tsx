...
export default function TeamBox({ team } : {team: TeamApiResponse}) {
    return (
        <section className="max-w-xl w-full mx-auto p-[2rem] rounded-2xl shadow-2xl flex flex-col md:flex-row justify-between items-center gap-[2rem] border border-black overflow-hidden bg-white">
            <div>
